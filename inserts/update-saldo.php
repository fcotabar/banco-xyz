...
echo "Retira: $" . number_format($valorRetiro). "<br><br>";
...
try {
    ...
    $sql = "INSERT INTO Movimiento (clienteId, tipoMvto, valorMvto)
            VALUES ('$clienteId', 'RETIRO', '-$valorRetiro')";
    $sql2 = "UPDATE Saldo SET valor = valor - $valorRetiro WHERE clienteId =  '$clienteId'";
